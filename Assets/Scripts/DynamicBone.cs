...
public class DynamicBone : MonoBehaviour
{
    ...
    public short _internalParentBoneId;
    ...
    private bool wasFixedUpdate = false;
    ...
    void CheckDistance()
    {
        ...
        float d = (Camera.main.transform.position-transform.position).sqrMagnitude;
