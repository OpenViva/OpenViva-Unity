...
public class SlidingDoor : MonoBehaviour
{
	...
	private void Awake(){
		...
		var colliderSelf = gameObject.GetComponent<Collider>();
		foreach( var ignoreCollider in ignoreColliders ){
			Physics.IgnoreCollision( colliderSelf, ignoreCollider, true );
		}
	}
	...
	public float GetUnitDistanceFromStart( Vector3 worldPosOnDoorPlane ){	//point must be on sliding plane
